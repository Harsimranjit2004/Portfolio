    ...
    <div className="align-center justify-center ">
      ...
      <div className="flex align-center justify-center gap-5 pt-9">
        <div className="w-1/2 border-2 border-gray-300 m-6 ">
          ...
          <div className="w-[97%] mb-2 m-3">
            <h3 className="p-2 text-lg font-bold">Blog Category</h3>
            <input
              type="text"
              id="category"
              name="category"
          ...
          <div className="w-[97%] mb-2 m-3">
            <h3 className="p-2 text-lg font-bold">Blog Reading Time</h3>
            <input
              type="text"
              id="readingTime"
              name="readingTime"
          ...
          <div className="w-[97%] mb-2 m-3">
            <h3 className="p-2 text-lg font-bold">Table of Content</h3>
            <input
              type="text"
              id="tableContent"
              name="tableContent"
