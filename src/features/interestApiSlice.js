...
//         const loadedInterst = responseData.map((interest) => {
...
//       },
//     }),
//     invalidatesTags: (result, error, arg) => [{ type: "Interest", id: arg.id }],
//   }),
...
// export const { useGetInterest} = interestApiSlice;
import { createSelector, createEntityAdapter } from "@reduxjs/toolkit";
import { apiSlice } from "../app/api/apiSlice";
